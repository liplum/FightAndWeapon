...
public abstract class RangedWeaponCore extends WeaponCore {
    ...
    private static final Function<FawWeaponLeftClickEvent, PSkillResult> RangedWeaponPS = event -> {
        WeaponBaseItem weapon = event.getWeapon();
    ...
    protected void build(@Nonnull WeaponCoreBuilder builder) {
        ...
        builder.set(
                ...
                new AggregatePassiveSkill("RangedWeaponPS")
                        .add(FawWeaponLeftClickEvent.class, RangedWeaponPS)
        ).set(
