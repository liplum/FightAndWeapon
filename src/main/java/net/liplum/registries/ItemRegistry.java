...
public final class ItemRegistry {
    ...
    //
    //Gemstone
    public static final Item Ruby_Item = gemstone(new GemstoneItem(Gemstones.Ruby));
    public static final Item Aquamarine_Item = gemstone(new GemstoneItem(Gemstones.Aquamarine));
    public static final Item Citrine_Item = gemstone(new GemstoneItem(Gemstones.Citrine));
    public static final Item Jadeite_Item = gemstone(new GemstoneItem(Gemstones.Jadeite));
    public static final Item Amethyst_Item = gemstone(new GemstoneItem(Gemstones.Amethyst));
    public static final Item Rose_Quartz_Item = gemstone(new GemstoneItem(Gemstones.RoseQuartz));
    public static final Item Turquoise_Item = gemstone(new GemstoneItem(Gemstones.Turquoise));

    public static final Item Flamegem_Item = gemstone(new GemstoneItem(Gemstones.Flamegem));
    public static final Item Marinegem_Item = gemstone(new GemstoneItem(Gemstones.Marinegem));
    public static final Item Earthgem_Item = gemstone(new GemstoneItem(Gemstones.Earthgem));
    public static final Item Forestgem_Item = gemstone(new GemstoneItem(Gemstones.Forestgem));
    public static final Item Endergem_Item = gemstone(new GemstoneItem(Gemstones.Endergem));
    public static final Item Magic_Pearl_Item = gemstone(new GemstoneItem(Gemstones.MagicPearl));
    public static final Item Windy_Gemstone_Item = gemstone(new GemstoneItem(Gemstones.Windy));
