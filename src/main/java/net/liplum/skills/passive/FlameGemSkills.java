...
public final class FlameGemSkills {
    public final static IPassiveSkill<TickEvent.PlayerTickEvent> FireProof = SkillManager.Instance().registerPassiveSkill(new IPassiveSkill<TickEvent.PlayerTickEvent>() {
        @Override
